...
namespace Lean.Touch
{
	...
	public class LeanPitchYaw : MonoBehaviour
	{
		...
		private bool triggerEventYaw;
		public UnityEvent onRotateDone;
		...
		protected virtual void LateUpdate()
		{
			...
			// if(Mathf.Approximately(currentYaw, Yaw) && triggerEventYaw) {
			if(Mathf.Abs(currentYaw - Yaw) < .01f && triggerEventYaw) {

				triggerEventYaw = false;
				onRotateDone?.Invoke();
				// Debug.Log($"Rotate Done {currentYaw} {Yaw}");
			}
		}
