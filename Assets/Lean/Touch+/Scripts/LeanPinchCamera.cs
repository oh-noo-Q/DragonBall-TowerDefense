...
namespace Lean.Touch
{
    ...
    public class LeanPinchCamera : MonoBehaviour
    {
        ...
        [Tooltip("Limit the FOV/Size?")] [UnityEngine.Serialization.FormerlySerializedAs("ZoomClamp")]
        public bool Clamp;
        ...
        [HideInInspector] [SerializeField] private float currentZoom;

        [HideInInspector] [SerializeField] private Vector3 remainingTranslation;
